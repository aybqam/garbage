    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" id="item">
                <img src="./image/slide-10.png" alt="Slide 1" style="width: 50%; height: 100%;">
            ...
            <div class="carousel-item" id="item">
                <img src="./image/slide-11.png" alt="Slide 1" style="width: 50%; height: 100%;">
                <div class="card-img-overlay">
                    <br><br>
                    <h5 class="card-title-2">For Summer</h5>
            ...
            <div class="carousel-item" id="item">
                <img src="./image/slide-12.png" alt="Slide 1" style="width: 50%; height: 100%;">
                <div class="card-img-overlay">
                    <br><br>
                    <h5 class="card-title-2">For Summer</h5>
...
<div class="card">
    ...
    <button class="btn btn-love" data-toggle="collapse" onclick="toggleLove(1, 'T-Shirt', 19.99, './image/tshirt.png'); return false;">
...
<div class="card">
    ...
    <button class="btn btn-love" data-toggle="collapse" onclick="toggleLove(2, 'T-Shirt 2', 19.99, './image/tshirt-4.png'); return false;">
...
function toggleLove(loveID) {
    ...
    if (document.getElementById("username-item")) {
       ...
       addFavorite(productId, name, price, image);
...
function addFavorite(productId, name, price, image) {
    $.ajax({
        url: 'add.php',
        method: 'POST',
        data: { id: productId, name: name, price: price, image: image },
