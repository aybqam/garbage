...
<nav class="navbar navbar-expand-sm navbar-dark bg-skyblue" aria-label="Third navbar example">
    ...
    <!-- More carousel items for more pages... -->
...
for (var i = 0; i < closeButtons.length; i++) {
  closeButtons[i].addEventListener('click', function() {
    ...
    <script>
        ...
        const prevPageLink = document.getElementById("prev-page").querySelector(".page-link");
        const nextPageLink = document.getElementById("next-page").querySelector(".page-link");

        // get the number of pages based on the number of products and products per page
        ...
        for (let i = 1; i <= numPages; i++) {
            ...
            li.id = `page${i}`;
            li.appendChild(a);
            paginationList.insertBefore(li, nextPageLink.parentNode);
        }
        ...
        paginationList.addEventListener("click", function(event) {
            ...
            if (pageLink) {
                const pageNum = parseInt(pageLink.innerText);
        ...
        // set up event listener for previous page link
        prevPageLink.addEventListener("click", function(event) {
            event.preventDefault();
            const currentPageNum = parseInt(document.querySelector(".page-item.active .page-link").innerText);
            if (currentPageNum > 1) {
        ...
        // set up event listener for next page link
        ...
        function updatePagination(pageNum) {
            ...
            const newActivePage = document.getElementById(`page${pageNum}`);
            newActivePage.classList.add("active");
            if (pageNum === 1) {
                prevPageLink.parentNode.classList.add("disabled");
            } else {
                prevPageLink.parentNode.classList.remove("disabled");
            }
            if (pageNum === numPages) {
                nextPageLink.parentNode.classList.add("disabled");
            } else {
                nextPageLink.parentNode.classList.remove("disabled");
            }
        }

        // initially show the first page of products
        updatePagination(1);
    </script>
