                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center align-middle">XLL</td>
                          ...
                          <i class="fa fa-trash" id="delete"></i>
                                ...
                                <td class="text-center align-middle">Product 4</td>
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="red-ball"></div>
                                    </div>
                          ...
                          <i class="fa fa-trash" id="delete"></i>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">Product 5</td>
                          ...
                          <i class="fa fa-trash" id="delete"></i>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">Product 6</td>
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="red-ball"></div>
                                    </div>
